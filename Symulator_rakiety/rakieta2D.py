...
for i in range(len(t) - 1):
    #warunek lotu
        ...
        if vx[i] > 0.1 or vx[i] < - 0.1:
            fi.append(math.atan2(vy[i], vx[i]))
        else:
            fi.append(fi[i])
...
print (math.atan2(434.0, 656565.0))
